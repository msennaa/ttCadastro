...
export default function Modal() {
  ...
  const registerEmployee = () => {
    ...
    axios.post('http://localhost:3001/employees', newEmployee)
      .then((response) =>  response.data.message ? alert(response.data.message) : window.location.reload())
        ...
        <div className="modal">
          ...
          <div className="modal-content">
            ...
            <div className="modal-buttons-container">
              ...
              <button type="button" disabled={validateAllInformations()} onClick={ () => registerEmployee() }>
                SALVAR
              </button>
            </div>
          </div>
